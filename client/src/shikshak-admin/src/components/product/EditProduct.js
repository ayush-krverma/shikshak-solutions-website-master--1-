...
import {commonUpdateFunction} from "../../../../shikshak-app/src/actions/CommonAction";
        ...
        swal({
            ...
            .then(async (success) => {
                if (success) {
                    ...
                    return await this.props.dispatch(commonUpdateFunction(dataToSend));
                    /*if (list) {
                            ...
                            <div className="card-body-table">
                                ...
                                <div className="news-content-right pd-20">
                                    ...
                                    <div className="button_price">
                                        <div className="form-group">
                                            <button className="checkprice" variant="contained" onClick={() => this.handleCheckPrice()} >Check price</button>
                                        </div>
